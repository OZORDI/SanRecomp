...
namespace PlatformPaths
{
    ...
    std::filesystem::path GetInstallDirectory()
    {
        if (!s_initialized)
        {
            ...
            s_installDir = GetHomeDirectory() / "SanRecomp";
#elif defined(__APPLE__)
            // macOS: ~/Library/Application Support/SanRecomp/
            s_installDir = GetHomeDirectory() / "Library" / "Application Support" / "SanRecomp";
#else // Linux
    ...
    {
        // The AES key is bundled in SanRecompLib/private/aes_key.bin
        ...
        if (_NSGetExecutablePath(path, &size) == 0)
        {
            ...
            // .app/Contents/MacOS/SanRecomp -> .app/Contents/Resources/
        ...
        std::vector<std::filesystem::path> devPaths = {
            "SanRecompLib/private/aes_key.bin",
            "../SanRecompLib/private/aes_key.bin",
            "../../SanRecompLib/private/aes_key.bin",
            "../../../SanRecompLib/private/aes_key.bin",
        };
