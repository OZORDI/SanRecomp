...
void CommonMenu::Draw()
{
    ...
    // GTA V Style: Orange strip instead of red
    auto redStripColour = GTA5Style::Colors::Orange;
    ...
    // GTA V Style: Dark background with subtle gradient
    auto gradientTop = GTA5Style::Colors::BackgroundDark;
    auto gradientBottom = GTA5Style::Colors::Background;
    auto gradientHeight = Scale(120, true);

    // Draw gradient to fill gap between red strip and top metal plates.
    // GTA V Style: Solid black background - no textures
    if (!ReduceDraw)
    {
        // Draw solid black header area
        drawList->AddRectFilled({ 0.0f, 0.0f }, { res.x, topPlateMotion + gradientHeight }, GTA5Style::Colors::Background);
    ...
    // GTA V Style: No metal plates - just solid black background (already drawn above)
    ...
    // GTA V Style: Dark panel color
    auto textCoverColour = GTA5Style::Colors::BackgroundPanel;
    ...
    if (!Description.empty())
    {
        ...
        // GTA V Style: Simple dark text cover (solid rectangle, no texture)
    ...
    {
        // GTA V Style: Solid black footer area - no metal plates
        ...
        drawList->AddRectFilled({ 0.0f, bottomPlateMotion }, { res.x, res.y }, GTA5Style::Colors::Background);
    }
