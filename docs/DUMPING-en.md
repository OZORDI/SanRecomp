# Dumping GTA V for Xbox 360

This guide explains how to extract Grand Theft Auto IV game files from your Xbox 360 for use with San Recompiled.
...
- Grand Theft Auto IV for Xbox 360
    ...
    - Episodes from Los Santos DLC is optional
...
> [!NOTE]
> If you have a digital copy of GTA V, skip to step 4.
...
11. Hold the CTRL key and click on **Grand Theft Auto IV** under the `Games` node. If you have Episodes from Los Santos installed, select that as well.
...
If you have a GTA V Xbox 360 ISO file, you can use it directly with San Recompiled's installer wizard. The installer supports:
