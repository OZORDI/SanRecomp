...
// GTA V Save Data Structure
struct GTA5SaveHeader
{
    static constexpr uint32_t SIGNATURE = 0x47544134; // "GTA5"
...
public:
    ...
    // GTA V save file management
    static bool LoadGTA5Save(int slot, void* buffer, size_t size);
    static bool SaveGTA5Save(int slot, const void* buffer, size_t size);
    static bool DeleteGTA5Save(int slot);
    static bool GTA5SaveExists(int slot);
    static std::filesystem::path GetGTA5SavePath(int slot);
};
